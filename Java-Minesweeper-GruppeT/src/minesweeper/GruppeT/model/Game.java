...
public class Game extends Observable {
     ...
     * if running, the true timer increments every second by 1
     */
    ...
    /**
     * Creates the Game board with "random" selection of bombs
     */
    ...
    /**
     * Returns the amount of nearby bombs
     *
     * @param y height
     * @param x width
    ...
    /**
     * Adds one to the number of revealed bombs and changes the state to won
     * if it was won.
     */
